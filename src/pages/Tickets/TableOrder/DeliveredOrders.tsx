...
export default function DeliveredOrders() {
  ...
  const ordersFilter = orders.filter(order => order.status === "finished" && order.isDelivered === false)
  ...
  return (
    <div>
      <div><h2 className='text-decoration-underline'>Entrega de Ordenes</h2></div>
              ...
              ordersFilter.map((p) => {
                return (
                  ...
                  >
                    ...
                    <td>{p.detail.reduce((total, price) => total + Number(price.subTotal), 0)}</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    ...
                    <td><span className='text-danger'>Finalizado</span></td>
                  </tr>
                )
              })
            }
